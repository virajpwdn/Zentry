  ...
  return (
    <section className="bg-black pb-52">
      <div className="container mx-auto px-3 md:px-10">
        ...
        <BentoTilt className="grid h-[135vh] w-full grid-cols-2 grid-rows-3 gap-7">
          ...
          <BentoTilt className="bento-tilt_1 row-span-1 md:col-span-1! ms-32 md:ms-0 border-hsla">
            <BentoCard
          ...
          <BentoTilt className="bento-tilt_1 row-span-1 md:col-span-1! me-14 md:me-0 border-hsla">
            <BentoCard
